...
int main() {
    ...
    if (unitConsumed <= 350) {
        ...
        totalAmount = 350 * 1.20 + (unitConsumed - 350) * 2.00;
    } else if (unitConsumed <= 800) {
        totalAmount = 350 * 1.20 + 250 * 2.00 + (unitConsumed - 600) * 3.00;
    } else {
        totalAmount = 350 * 1.20 + 250 * 2.00 + 200 * 3.00 + (unitConsumed - 800) * 4.00;
    }
